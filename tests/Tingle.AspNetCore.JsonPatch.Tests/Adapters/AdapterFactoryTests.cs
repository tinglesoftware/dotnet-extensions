...
namespace Tingle.AspNetCore.JsonPatch.Test.Adapters;
...
public class AdapterFactoryTests
{
    ...
    //    //Act:
    //    IAdapter adapter = factory.Create(new Dictionary<string, string>(), new JsonSerializerOptions());
    ...
    public void GetPocoAdapterForGenericObjects()
    {
        ...
        //Act:
        IAdapter adapter = factory.Create(new PocoModel(), new JsonSerializerOptions());
    ...
    //    //Act:
    //    IAdapter adapter = factory.Create(new TestDynamicObject(), new JsonSerializerOptions());
