...
public class ListIntegrationTest
{
    ...
    public void AddToIntegerIList()
    {
        ...
        // Assert
        Assert.Equal([4, 1, 2, 3], targetObject.SimpleObject.IntegerIList);
    }
    ...
    public void AddToListAppend()
    {
        ...
        // Assert
        Assert.Equal([1, 2, 3, 4], targetObject.SimpleObject.IntegerList);
    }
    ...
    public void RemoveFromList()
    {
        ...
        // Assert
        Assert.Equal([1, 2], targetObject.IntegerList);
    }
    ...
    public void Remove_FromEndOfList()
    {
        ...
        // Assert
        Assert.Equal([1, 2], targetObject.SimpleObject.IntegerList);
    }
    ...
    public void ReplaceFullList_WithCollection()
    {
        ...
        // Assert
        Assert.Equal([4, 5, 6], targetObject.IntegerList);
    }
    ...
    public void Replace_AtEndOfList()
    {
        ...
        // Assert
        Assert.Equal([1, 2, 5], targetObject.SimpleObject.IntegerList);
    }
    ...
    public void CopyFromListToEndOfList()
    {
        ...
        // Assert
        Assert.Equal([1, 2, 3, 1], targetObject.IntegerList);
    }
    ...
    public void MoveToEndOfList()
    {
        ...
        Assert.Equal([1, 2, 3, 5], targetObject.IntegerList);
    }
    ...
    public void Move_KeepsObjectReferenceInList()
    {
        ...
        // Assert
        Assert.Equal([simpleObject2, simpleObject1, simpleObject3], targetObject.SimpleObjectList);
    ...
    public void MoveFromList_ToNonList_BetweenHierarchy()
    {
        ...
        // Assert
        Assert.Equal([2, 3], targetObject.SimpleObject.IntegerList);
        Assert.Equal(1, targetObject.IntegerValue);
    }
}
