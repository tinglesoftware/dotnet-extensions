...
public class KeygenTests
{
    ...
    public static TheoryData<string, Keygen.OutputFormat, Encoding?, string> CreateTestData => new()
    {
    ...
    public static TheoryData<string, Keygen.OutputFormat, Encoding, string> DecodeTestData => new()
    {
