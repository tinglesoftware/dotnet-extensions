...
// See https://stackoverflow.com/questions/60580743/what-is-equivalent-in-jtoken-deepequals-in-system-text-json
public class JsonElementComparer(int maxHashDepth) : IEqualityComparer<JsonElement>
{
    public JsonElementComparer() : this(-1) { }

    int MaxHashDepth { get; } = maxHashDepth;
